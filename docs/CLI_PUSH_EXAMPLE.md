...
For a ready-made implementation (Node.js), use [gittr-mcp](https://gittr.space/arbadacarbaYK/gittr?branch=main-mcp): `pushToBridge({ ownerPubkey, repo, branch, files, privkey })` handles challenge and auth automatically.
