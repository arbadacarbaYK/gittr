...
**Nostr Pages (after Push Manifest):** platform docs hub lives at repo-root `index.html` in **gittr** — listed as slug `gittr`, URL […qkgittr.pages.gittr.space](https://3un05jr4dnwh6njreq6uhzgv67st83jxi5lnpsbf8y3dkdq1qkgittr.pages.gittr.space/). Client cookbook is **gittr-helper-tools**, URL […qkhelper-tools.pages.gittr.space](https://3un05jr4dnwh6njreq6uhzgv67st83jxi5lnpsbf8y3dkdq1qkhelper-tools.pages.gittr.space/).
