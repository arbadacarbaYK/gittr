...
- **Insights tab:** Stars use the same live NIP-25 count as the header Star button (not a stale `gittr_repos.stars` snapshot). Files, commits, and languages also refresh from the bridge git store and the GitHub upstream the header already knows.
