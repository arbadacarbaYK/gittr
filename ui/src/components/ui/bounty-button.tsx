    ...
    try {
      ...
      if (onBountyCreated) {
        if (!withdrawId || !withdrawUrl) {
          throw new Error(
            "Withdraw link created but ID/URL not found. Please try again."
          );
        }
          ...
          <div className="flex flex-col gap-2">
              ...
              <div className="text-xs text-yellow-400 bg-yellow-900/20 border border-yellow-600/50 p-2 rounded">
                <div className="flex items-start gap-2">
                  ...
                  <div className="flex-1">
                    <strong>LNbits wallet required:</strong> You need to
                    configure your LNbits sending wallet in{" "}
                    <Link
                    ...
                    to create bounties. The withdraw link will be created from
                    your LNbits wallet and funds will be reserved there until
                    the PR author claims it.
                  </div>
                </div>
              </div>
            )}
            {hasLnbitsConfig === true && (
              <div className="text-xs text-gray-400 bg-gray-800/50 p-2 rounded">
                <strong>Bounty System:</strong> The bounty amount will be
                deducted from your LNbits wallet and a withdraw link will be
                created. Make sure you have sufficient balance in your wallet.
                When a PR fixing this issue is merged, the withdraw link will be
                released to the PR author. They can claim the bounty using the
                withdraw link. The funds are already reserved in your wallet and
                will be deducted when they claim it.
                <Link
                  href="/help#bounties"
            ...
            {hasLnbitsConfig === null && (
              <div className="text-xs text-gray-400 bg-gray-800/50 p-2 rounded">
                💡 <strong>Bounty System:</strong> Checking LNbits
                configuration...
              </div>
            )}
