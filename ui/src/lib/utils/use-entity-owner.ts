...
import { resolveEntityToPubkey, getRepoOwnerPubkey, getEntityDisplayName, getEntityPicture } from "./entity-resolver";
 ...
 */
export function useEntityOwner(options: UseEntityOwnerOptions): EntityOwnerResult {
