 ...
 */
export function normalizeEntityForStorage(entity: string | undefined | null): string {
  if (!entity) return "";
 ...
 */
export function getRepoStorageKey(prefix: string, entity: string, repo: string): string {
