...
- **Issues & PRs on Nostr** — Same workflow as a normal forge. Events are NIP-34 and related kinds. The PR page loads the real file diff from git or GitHub (the Nostr event is the title/description only).
