...
**Docs hub (Nostr Page):** root [`index.html`](./index.html) — what you can do on gittr, a clickable platform map, and links into gittr / gitnostr / pyramid / nsite / gittr-mcp / gittr-snips. **Push Manifest** on this repo uploads that hub (`index.html`, `docs-site/`, docs images) — not the Next.js app in `ui/`. After it succeeds, the page is listed on [gittr.space/pages](https://gittr.space/pages) as **gittr-docu** (`https://3un05jr4dnwh6njreq6uhzgv67st83jxi5lnpsbf8y3dkdq1qkgittr-docu.pages.gittr.space/`). Sister cookbook: [gittr-snips](https://3un05jr4dnwh6njreq6uhzgv67st83jxi5lnpsbf8y3dkdq1qkgittr-snips.pages.gittr.space/) (repo `gittr-helper-tools`; NIP-5A site names are 1–13 characters, so the repo slug cannot be the Pages name).
