...
Live: [gittr.space](https://gittr.space) · [Apps](https://gittr.space/apps) · [Pages](https://pages.gittr.space) · [Nostr schemata (NIPs)](https://gittr.space/npub1zafcms4xya5ap9zr7xxr0jlrtrattwlesytn2s42030lzu0dwlzqpd26k5/schemata?file=README.md)
...
| **Git server (bridge)** | **[gitnostr](https://gittr.space/arbadacarbaYK/gitnostr?branch=main)** (`ui/gitnostr/`)                            | `git-nostr-bridge`, SSH/HTTPS bare repos, kind **52** SSH keys, optional **`push_cost_sats`** paywall, **`git-nostr-cli`** (`gn`). **Not the same as ngit.** |
...
| **[gittr-helper-tools](https://gittr.space/arbadacarbaYK/gittr?branch=main-helper-tools)**          | **Integrator snippets** from gittr production (GRASP detection, NIP-46, file fetch, etc.)—not a hosted forge; helper snippets for all clients and companion to this repo.                                                                                           |
...
- **gittr** — built on **[gitnostr](https://gittr.space/arbadacarbaYK/gitnostr?branch=main)** (`ui/gitnostr/`, MIT): `git-nostr-bridge`, `git-nostr-ssh`, `git-nostr-cli` (`gn`). Web-only features (bounties, Pages, `/apps`, import UI) live in this repo.
...
| Project                                            | Role                                                                                                                                                                             |
| -------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [gitnostr](https://gittr.space/arbadacarbaYK/gitnostr?branch=main) | **Git server** (bridge/SSH) — [`ui/gitnostr/`](ui/gitnostr/) in this monorepo; same tree on [gittr.space](https://gittr.space/arbadacarbaYK/gitnostr?branch=main) |
