...
| **gittr-mcp** (AI agents)     | **Yes** ([install](https://github.com/arbadacarbaYK/gittr-mcp#install-5-minutes)) | MCP in Cursor/Claude/etc.; HTTP + Nostr against gittr.space (or self-hosted gittr). Not SSH git.                                                                                                                          |
