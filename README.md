...
| Web of Trust badges               | Yes (hops from *you*)                   | ?                                                                                                     | ?                                                                                                                 |
| External identities (NIP-39)      | Yes (Settings → Profile)                | ?                                                                                                     | ?                                                                                                                 |
| Security lab map (`/lab`)         | Yes (display-only snapshot)             | ?                                                                                                     | ?                                                                                                                 |
| Releases (kind 30063)             | Yes                                     | ?                                                                                                     | Yes (per [upstream README](https://codeberg.org/dluvian/gitplaza))                                                |


**Notes**

- **gittr** — built on **[gitnostr](https://gittr.space/npub1n2ph08n4pqz4d3jk6n2p35p2f4ldhc5g5tu7dhftfpueajf4rpxqfjhzmc/gitnostr?branch=main)** (`ui/gitnostr/`, MIT): `git-nostr-bridge`, `git-nostr-ssh`, `git-nostr-cli` (`gn`). The hosted forge extras (notifications, CVE DMs, zap splits, snippets, repo links, fork/star/watch, delete, profile Pages/apps, Activity Timeline, Web of Trust badges, NIP-39 identities, `/lab`) live in this repo. The public hub **What you can do** list matches Help.
